            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- パスワード確認用 -->
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-3 col-form-label text-md-right">{{ __('パスワード確認用') }}</label>
                        ...
                        <!-- 活動地域 -->
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-3 col-form-label text-md-right">{{ __('活動地域') }}</label>
                     ...
                     <div class="form-group row mb-3">
                        ...
                        <label for="band_level" class="col-3 col-form-label text-md-right"><p>バンドのレベル感</p></label>
                        <div class="col-8">
                     ...
                     <div class="form-group row mb-3">
                        <label for="activity_level" class="col-3 col-form-label text-md-right"><p>活動レベル</p></label>
                        <div class="col-8">
                     ...
                     <div class="form-group row mb-3">
                        <label for="genre" class="col-3 col-form-label text-md-right"><p> ジャンル</p></label>
                        <div class="col-9">
                            <div class="form-check  form-check-inline" >
                                <input class="form-check-input" type="checkbox" id="genre" checked>
                     ...
                     <div class="form-group row mb-3">
                        <label for="activity_timezone" class="col-3 col-form-label text-md-right"><p>活動時間帯</p></label>
                        <div class="col-8">
                     ...
                     <div class="form-group row mb-3">
                        <label for="favorite_artist" class="col-3 col-form-label text-md-right"><p>好きなアーティスト</p></label>
                        <div class="col-8">
                     ...
                     <div class="form-group row mb-3">
                        <label for="favorite_artist" class="col-3 col-form-label text-md-right"><p>性別</p></label>
                        <div class="col-9">
                     ...
                     <div class="form-group row mb-3">
                        <label for="favorite_artist" class="col-3 col-form-label text-md-right"><p>年齢</p></label>
                        <div class="col-9">
                        <div class="custom-control custom-radio custom-control-inline ml-3">
